...
from recipe.views import recipe_detail, recipe_list, update_recipe, delete_recipe, like_recipe
from recipe.views import create_recipe, add_comment, save_to_cookbook, unsave_from_cookbook, edit_comment, delete_comment
...
urlpatterns = [
    ...
    path('recipe/<int:recipe_id>/save/', save_to_cookbook, name='save_to_cookbook'),
    path('recipe/<int:recipe_id>/unsave/', unsave_from_cookbook, name='unsave_from_cookbook'),
